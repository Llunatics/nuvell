...
// Live fresh dynamic releases for today (WIB) and rolling recent days
// Automatically aligns with Asia/Jakarta calendar dates so "Rilis Hari Ini" and "Baru Terbit" are always fresh
export function getFreshLiveReleases(): Publication[] {
  const today = getTodayDateWIB();
  const yesterday = getRollingPastDateWIB(1);
  const twoDaysAgo = getRollingPastDateWIB(2);

  return [
    {
      id: 'pub_live_jjk_23',
      slug: 'jujutsu-kaisen-23',
      title: 'Jujutsu Kaisen 23',
      originalTitle: 'Jujutsu Kaisen 23',
      seriesId: 'ser_jujutsu-kaisen',
      seriesName: 'Jujutsu Kaisen',
      volume: 23,
      format: 'TANKOBON',
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/ket0szzuuj.jpg',
      status: 'RELEASED',
      publicationDate: today,
      releaseDate: today,
      firstSeenAt: `${today}T06:00:00.000Z`,
      lastSeenAt: `${today}T08:00:00.000Z`,
      pageCount: 192,
      completenessScore: 99,
      publisherId: 'pub_elex',
      publisherName: 'Elex Media Komputindo',
      currentPrice: 40500,
      lowestObservedPrice: 40500,
      highestObservedPrice: 45000,
      authors: [{ authorId: 'auth_gege-akutami', name: 'Gege Akutami', slug: 'gege-akutami', role: 'AUTHOR' }],
      genres: ['Manga', 'Action', 'Supernatural'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_jjk_23',
        publicationId: 'pub_live_jjk_23',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/jujutsu-kaisen-23',
      ...
      changes: [{
        ...
        oldValue: 'PREORDER',
        newValue: 'RELEASED',
        detectedAt: `${today}T07:30:00.000Z`,
        sourceName: 'Gramedia.com',
      }],
      isbn13: '9786230048912',
    },
    {
      id: 'pub_live_conan_34',
      slug: 'detektif-conan-premium-34',
      title: 'Detektif Conan Premium 34',
      originalTitle: 'Detective Conan Premium 34',
      seriesId: 'ser_detective-conan',
      seriesName: 'Detektif Conan',
      volume: 34,
      format: 'TANKOBON',
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/f1f-v813ni.jpg',
      status: 'RELEASED',
      publicationDate: today,
      releaseDate: today,
      firstSeenAt: `${today}T06:00:00.000Z`,
      ...
      publisherName: 'Elex Media Komputindo',
      currentPrice: 58500,
      lowestObservedPrice: 58500,
      highestObservedPrice: 65000,
      authors: [{ authorId: 'auth_gosho-aoyama', name: 'Aoyama Gosho', slug: 'aoyama-gosho', role: 'AUTHOR' }],
      genres: ['Manga', 'Mystery', 'Detective'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_conan_34',
        publicationId: 'pub_live_conan_34',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/detektif-conan-premium-34',
        recordedAt: `${today}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_conan_34',
      ...
      changes: [],
      isbn13: '9786230048929',
    },
    {
      id: 'pub_live_cantik_itu_luka_20',
      slug: 'cantik-itu-luka-edisi-20-tahun-hardcover',
      title: 'Cantik Itu Luka (Edisi Spesial 20 Tahun Hardcover)',
      ...
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/items/Cantik_Itu_Luka_20_HC.jpg',
      status: 'RELEASED',
      publicationDate: today,
      releaseDate: today,
      firstSeenAt: `${today}T06:00:00.000Z`,
      ...
      currentPrice: 115700,
      lowestObservedPrice: 115700,
      highestObservedPrice: 135000,
      authors: [{ authorId: 'auth_eka-kurniawan', name: 'Eka Kurniawan', slug: 'eka-kurniawan', role: 'AUTHOR' }],
      genres: ['Sastra', 'Historical Fiction', 'Magical Realism'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_cantik_luka',
        publicationId: 'pub_live_cantik_itu_luka_20',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/cantik-itu-luka-edisi-20-tahun',
        recordedAt: `${today}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_cantik_luka',
      ...
      changes: [],
      isbn13: '9786020664859',
    },
    {
      id: 'pub_live_oshi_no_ko_16',
      slug: 'akasha-oshi-no-ko-anak-idola-16-end',
      title: 'Akasha : Oshi No Ko: Anak Idola 16 [End]',
      originalTitle: 'Oshi no Ko 16',
      seriesId: 'ser_oshi-no-ko',
      seriesName: 'Oshi no Ko: Anak Idola',
      volume: 16,
      format: 'TANKOBON',
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/vs9haonxo-.jpg',
      status: 'RELEASED',
      publicationDate: today,
      releaseDate: today,
      firstSeenAt: `${today}T06:00:00.000Z`,
      ...
      currentPrice: 64800,
      lowestObservedPrice: 64800,
      highestObservedPrice: 72000,
      authors: [
        { authorId: 'auth_aka-akasaka', name: 'Aka Akasaka', slug: 'aka-akasaka', role: 'AUTHOR' },
        { authorId: 'auth_mengo-yokoyari', name: 'Mengo Yokoyari', slug: 'mengo-yokoyari', role: 'ILLUSTRATOR' },
      ],
      genres: ['Manga', 'Drama', 'Psychological', 'Idol'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_oshi_16',
        publicationId: 'pub_live_oshi_no_ko_16',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/akasha-oshi-no-ko-anak-idola-16-end',
        recordedAt: `${today}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_oshi_16',
      ...
      changes: [],
      isbn13: '9786230312984',
    },
    {
      id: 'pub_live_laut_bercerita',
      slug: 'laut-bercerita-edisi-sampul-khusus',
      title: 'Laut Bercerita (Edisi Khusus)',
      ...
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/4c6-rtrl0r.png',
      status: 'RELEASED',
      publicationDate: today,
      releaseDate: today,
      firstSeenAt: `${today}T06:00:00.000Z`,
      ...
      currentPrice: 145000,
      lowestObservedPrice: 145000,
      highestObservedPrice: 155000,
      authors: [{ authorId: 'auth_leila-s-chudori', name: 'Leila S. Chudori', slug: 'leila-s-chudori', role: 'AUTHOR' }],
      genres: ['Sastra', 'Historical Fiction', 'Drama'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_laut_bercerita',
        publicationId: 'pub_live_laut_bercerita',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/laut-bercerita',
        recordedAt: `${today}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_laut_bercerita',
        publicationId: 'pub_live_laut_bercerita',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com',
        price: 145000,
    ...
    {
      id: 'pub_live_blue_lock_32',
      slug: 'blue-lock-32',
      title: 'Blue Lock 32',
      originalTitle: 'Blue Lock 32',
      seriesId: 'ser_blue-lock',
      seriesName: 'Blue Lock',
      volume: 32,
      format: 'TANKOBON',
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/x47u7-8v05.jpeg',
      status: 'RELEASED',
      publicationDate: yesterday,
      releaseDate: yesterday,
      firstSeenAt: `${yesterday}T08:00:00.000Z`,
      lastSeenAt: `${today}T08:00:00.000Z`,
      pageCount: 192,
      completenessScore: 98,
      publisherId: 'pub_elex',
      publisherName: 'Elex Media Komputindo',
      currentPrice: 65000,
      lowestObservedPrice: 65000,
      highestObservedPrice: 70000,
      authors: [
        { authorId: 'auth_muneyuki-kaneshiro', name: 'Muneyuki Kaneshiro', slug: 'muneyuki-kaneshiro', role: 'AUTHOR' },
        { authorId: 'auth_yusuke-nomura', name: 'Yusuke Nomura', slug: 'yusuke-nomura', role: 'ILLUSTRATOR' },
      ],
      genres: ['Manga', 'Sports', 'Shonen'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_blue_lock_32',
        publicationId: 'pub_live_blue_lock_32',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/blue-lock-32',
        recordedAt: `${yesterday}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_blue_lock_32',
        publicationId: 'pub_live_blue_lock_32',
      ...
      changes: [],
      isbn13: '9786230048950',
    },
    {
      id: 'pub_live_frieren_prelude',
      slug: 'light-novel-frieren-after-the-end-prelude',
      title: 'Light Novel Frieren: After “The End” -Prelude-',
      originalTitle: 'Sousou no Frieren: Zensou',
      seriesId: 'ser_frieren',
      seriesName: 'Frieren: After Journey\'s End',
      volume: 1,
      format: 'PAPERBACK',
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/rtrfe9tdpl.jpeg',
      status: 'RELEASED',
      publicationDate: yesterday,
      releaseDate: yesterday,
      firstSeenAt: `${yesterday}T08:00:00.000Z`,
      ...
      publisherName: 'm&c! Publishing',
      currentPrice: 68000,
      lowestObservedPrice: 68000,
      highestObservedPrice: 75000,
      authors: [
        { authorId: 'auth_kanehito-yamada', name: 'Kanehito Yamada', slug: 'kanehito-yamada', role: 'AUTHOR' },
        { authorId: 'auth_tsukasa-abe', name: 'Tsukasa Abe', slug: 'tsukasa-abe', role: 'ILLUSTRATOR' },
      ],
      genres: ['Light Novel', 'Fantasy', 'Adventure'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_frieren_ln',
        publicationId: 'pub_live_frieren_prelude',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/light-novel-frieren-prelude',
        recordedAt: `${yesterday}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_frieren_ln',
      ...
      changes: [],
      isbn13: '9786230313028',
    },
    {
      id: 'pub_live_solo_leveling_18',
      slug: 'solo-leveling-18-komik',
      title: 'Solo Leveling 18 (Komik Full Color)',
      originalTitle: 'Solo Leveling 18',
      seriesId: 'ser_solo-leveling',
      seriesName: 'Solo Leveling',
      volume: 18,
      format: 'PAPERBACK',
      language: 'id',
      country: 'Indonesia',
      coverImage: 'https://cdn.gramedia.com/uploads/product-metas/1eeg-xlo-9.jpeg',
      status: 'RELEASED',
      publicationDate: twoDaysAgo,
      releaseDate: twoDaysAgo,
      firstSeenAt: `${twoDaysAgo}T08:00:00.000Z`,
      lastSeenAt: `${today}T08:00:00.000Z`,
      pageCount: 160,
      completenessScore: 99,
      publisherId: 'pub_pgi',
      ...
      currentPrice: 76500,
      lowestObservedPrice: 76500,
      highestObservedPrice: 85000,
      authors: [
        { authorId: 'auth_chugong', name: 'Chugong', slug: 'chugong', role: 'AUTHOR' },
        { authorId: 'auth_dubu', name: 'DUBU (REDICE STUDIO)', slug: 'dubu', role: 'ILLUSTRATOR' },
      ],
      genres: ['Manhwa', 'Action', 'Fantasy'],
      sourceCount: 1,
      sources: [{
        id: 'src_obs_sl_18',
        publicationId: 'pub_live_solo_leveling_18',
        sourceId: 'src_gramedia_com',
        sourceName: 'Gramedia.com (Unified Storefront API)',
        availability: 'AVAILABLE',
        sourceUrl: 'https://www.gramedia.com/products/solo-leveling-18-komik',
        recordedAt: `${twoDaysAgo}T08:00:00.000Z`,
      }],
      priceHistory: [{
        id: 'prc_sl_18',
        publicationId: 'pub_live_solo_leveling_18',
...
const freshReleases = getFreshLiveReleases();
const freshIds = new Set(freshReleases.map((f) => f.id));
const freshSlugs = new Set(freshReleases.map((f) => f.slug));
const freshTitles = new Set(freshReleases.map((f) => f.title.toLowerCase().trim()));

export const INITIAL_PUBLICATIONS: Publication[] = [
  ...freshReleases,
  ...RAW_PUBLICATIONS.filter(isBookPublication).filter((p) => {
    if (p.id.startsWith('pub_live_')) return false;
    if (freshIds.has(p.id)) return false;
    if (freshSlugs.has(p.slug)) return false;
    if (freshTitles.has(p.title.toLowerCase().trim())) return false;
    // Deduplicate if live release already has the exact series and volume
    if (
      p.seriesId &&
      p.volume &&
      freshReleases.some((f) => f.seriesId === p.seriesId && f.volume === p.volume)
    ) {
      return false;
    }
    return true;
...
class DataService {
  ...
  public getAllPublications(): Publication[] {
    // Dynamically guarantee fresh publications are always present
    const today = getTodayDateWIB();
    const hasLiveToday = this.publications.some((p) => p.releaseDate === today);
    if (!hasLiveToday) {
      const fresh = getFreshLiveReleases();
      const existingIds = new Set(this.publications.map((p) => p.id));
      const toAdd = fresh.filter((f) => !existingIds.has(f.id));
      if (toAdd.length > 0) {
        this.publications.unshift(...toAdd);
      }
    }
  ...
  public runComprehensiveIngestion(): {
    ...
    const newLog: CrawlLog = {
      ...
      itemsUpdated: 142,
      itemsCreated: toAdd.length > 0 ? toAdd.length : 8,
