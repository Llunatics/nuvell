...
export default function AdminPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-12 space-y-6">
      ...
      <div className="px-4 py-3 sm:px-5 sm:py-3.5 rounded-2xl bg-surface/80 border border-white/[0.06] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs sm:text-sm shadow-xs">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-surface hover:bg-surface-raised border border-white/[0.06] text-editorial-muted hover:text-editorial-title transition-all font-medium text-xs sm:text-sm self-start sm:self-auto shadow-xs"
        >
